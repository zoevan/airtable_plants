...
#			print("PRINT OF #{response}") => this was for testing data pulled in via API. Delete this
#			print("PRINT OF #{records}")
...
#			print("Fetch complete for #{data}")
		end

		File.open(dirname + "/" + table['name'].parameterize + "params.json", "w") do |file|
